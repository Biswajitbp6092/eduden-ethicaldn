...
const Faq = () => {
  ...
  return (
    <section className="bg-black text-white pt-[100px] lg:pt-[150px] px-4 lg:px-20 py-16">
      {/* Heading */}
      <h2 className="text-5xl font-bold leading-normal text-white pb-[80px]">
      ...
      <div className="flex flex-col lg:flex-row gap-10 min-w-0">
        ...
        {/* Contact Box */}
        <div className="bg-[#1e1e1e] flex-shrink-0 flex flex-col justify-center items-center p-8 rounded-lg text-center max-w-md mx-auto">
